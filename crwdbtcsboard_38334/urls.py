...
urlpatterns = [
    ...
    path("rest-auth/registration/account-confirm-email/<str:key>/", confirm_email),path("api/v1/", include("apps.api.v1.urls")), path("api/v1/", include("applications.api.v1.urls")), path("apps/", include("apps.urls"))
