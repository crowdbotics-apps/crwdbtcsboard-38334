...
urlpatterns = [
    ...
    path("rest-auth/registration/", include("rest_auth.registration.urls")),path("api/v1/", include("plans.api.v1.urls")), path("api/v1/", include("applications.api.v1.urls")), path("applications/", include("applications.urls")), path("plans/", include("plans.urls"))
