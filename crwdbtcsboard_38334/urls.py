...
urlpatterns = [
    ...
    path("api/v1/", include("apps.api.v1.urls")), path("apps/", include("apps.urls")), path("api/v1/", include("applications.api.v1.urls")), path("applications/", include("applications.urls")), path("api/v1/", include("plans.api.v1.urls"))
